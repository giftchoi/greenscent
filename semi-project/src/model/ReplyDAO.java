...
//tip 댓글부분--------------------------------------------------------------===============
		...
		public ArrayList<ReplyVO> getTReplyListBytNo(int tNo) throws SQLException {
			ArrayList<ReplyVO> trvoList = new ArrayList<ReplyVO>();
			Connection con = null;
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			try {
				...
				while (rs.next())
					trvoList.add(
							new ReplyVO(rs.getString(1), tNo + "", rs.getString(2), rs.getString(3), rs.getString(4)));
			} finally {
				closeAll(rs, pstmt, con);
			}
...
// Qna 댓글부분--------------------------------------------------------------============
	public void writeReplyInQna(ReplyVO rvo) throws SQLException {
		...
		try {
			con = dataSource.getConnection();
			StringBuilder sql = new StringBuilder();
			sql.append("insert into qna_reply(qrno,qno,id,content,regDate)");
			sql.append(" values (tip_reply_seq.nextval, ?,?,?,sysdate)");
			pstmt = con.prepareStatement(sql.toString());
			pstmt.setString(1, rvo.getNo());
			pstmt.setString(2, rvo.getId());
	...
	public ArrayList<ReplyVO> getQReplyListBytNo(int qNo) throws SQLException {
		...
		try {
			con = dataSource.getConnection();
			StringBuilder sql = new StringBuilder();
			sql.append("select qrno, id, content, regdate from qna_reply where qno=?");
			pstmt = con.prepareStatement(sql.toString());
			pstmt.setInt(1, qNo);
			rs = pstmt.executeQuery();
			while (rs.next())
	...
	public void writeReplyInMarket(ReplyVO rvo) throws SQLException {
		...
		try {
			con = dataSource.getConnection();
			StringBuilder sql = new StringBuilder();
			sql.append("insert into m_reply(mrno,tno,id,content,regDate)");
			sql.append(" values (tip_reply_seq.nextval, ?,?,?,sysdate)");
			pstmt = con.prepareStatement(sql.toString());
			pstmt.setString(1, rvo.getNo());
			pstmt.setString(2, rvo.getId());
	...
	public ArrayList<ReplyVO> getMReplyListBytNo(int tNo) throws SQLException {
		ArrayList<ReplyVO> trvoList = new ArrayList<ReplyVO>();
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
			...
			rs = pstmt.executeQuery();
			while (rs.next())
				trvoList.add(new ReplyVO(rs.getString(1), tNo + "", rs.getString(2), rs.getString(3), rs.getString(4)));
		} finally {
			closeAll(rs, pstmt, con);
		}
	...
	public ArrayList<ReplyVO> getDReplyListBytNo(int tNo) throws SQLException {
		ArrayList<ReplyVO> trvoList = new ArrayList<ReplyVO>();
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
